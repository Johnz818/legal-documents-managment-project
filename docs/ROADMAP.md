...
| Phase 2 — Case Document Management | In progress | D1 architecture decisions are accepted, D2 defines the storage contract, and D3 persists Case document metadata. | Implement D4, the local storage adapter. |
